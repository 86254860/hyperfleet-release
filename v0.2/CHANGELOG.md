...
- **API Endpoints and Resources**
  - **Clusters**: Full CRUD operations (Create, Read, List, Patch, Delete)
  - **NodePools**: Full CRUD with parent cluster association and cascade delete
...
- **Comprehensive Metrics**
  - 7 core Prometheus metrics with labels for resource_type and resource_selector
...
- **Transporter Implementations**
  - **Kubernetes Transporter**: Direct Kubernetes API access with in-cluster or kubeconfig authentication
    - CRUD operations: CreateResource, UpdateResource, DeleteResource, ApplyManifest
  ...
  - **Maestro Transporter**: Remote cluster management via Maestro/OCM ManifestWork
    ...
    - ManifestWork CRUD: CreateManifestWork, GetManifestWork, ApplyManifestWork, DeleteManifestWork
...
- **Observability and Monitoring**
  - Prometheus metrics with ServiceMonitor resource
